...
import 'package:shapeyou_admin/services/firebase_services.dart';
...
var _usernameTextController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    progressDialog.show();
    _services.getAdminCredentials(username).then((value){
     if(value.exists){
       ...
       _showMyDialog(title: 'Login Failed', message: 'Incorrect Username or Password');
     }
    });
  }
